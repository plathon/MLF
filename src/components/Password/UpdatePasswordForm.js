...
class NormalUpdatePasswordForm extends Component {
    ...
    handleSubmit = (e) => {
        ...
        if (!err) {
            ...
            this.props.PasswordStore.updatePassword(password, confirm)
            console.log(values)
        }
        });
    }
    ...
    render() {
        ...
        <Form onSubmit={this.handleSubmit} className="login-form">
            ...
            <Form.Item>
                <Button type="primary" htmlType="submit" className="login-form-button" loading={this.props.PasswordStore.isLoading}>
                    Reset Password
                </Button>
            </Form.Item>
